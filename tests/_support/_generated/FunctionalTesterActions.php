<?php  //[STAMP] 5bec7291b1382eb5d5c04242558ae9b6
...
trait FunctionalTesterActions
{
     ...
     *
     * @return array
     * @see \modules\Functional::decodeJson()
     */
    public function decodeJson($jsonString) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('decodeJson', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \modules\Functional::grabResponse()
     */
     ...
     *
     * @return mixed
     * @see \modules\Functional::sendYiiPostRequest()
     */
    public function sendYiiPostRequest($route, $data = null, $files = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('sendYiiPostRequest', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \modules\Functional::assertArrayValue()
     */
    public function assertArrayValue($expected, $key, $array) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertArrayValue', func_get_args()));
    }
}
