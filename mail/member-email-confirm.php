...
<title>Limelight Member Confirm</title>
...
<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" bgcolor="#f2f2f2" style="border-collapse:collapse;">
  <tr>
    <td><center style="width: 100%;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: raleway;"> <?= Yii::$app->name; ?> | Member Activation </div>
