...
<title>Limelight E-Mail Password</title>
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#f6f6f6" width="100%" style="max-width: 600px; border: none; ">
            ...
            <tr>
              <td><table cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td style="padding: 45px; font-family: 'Raleway', sans-serif; font-size: 30px; font-weight: 800; mso-height-rule: exactly; line-height: 28px; color: black; text-align: center"> You have requested to reset your password on <?= Yii::$app->name; ?><br>
                      <br>

						<span style="font-family: 'Raleway', sans-serif; font-size: 16px; font-weight: 400; line-height: 8px;">To reset your password click on the link below. From here you can fill out a form which will reset your password for you.</span>
						<br><br>
                      ...
                      <!-- Button : END --> 
					   ...
					   <tr>
                                  <td style="padding: 20px; font-family: 'Raleway', sans-serif; font-size: 16px; font-weight: 100; mso-height-rule: exactly; line-height: 16px; color: black; text-align: center" class="stack-column-center"> If you have not requested a password reset please contact an admin at <a href="mailto:<?= Yii::$app->params['senderEmail']; ?>">
