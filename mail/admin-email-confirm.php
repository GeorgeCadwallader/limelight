...
<title>Limelight Admin Confimation</title>
          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#f6f6f6" width="100%" style="max-width: 600px; border: none; ">
            ...
            <tr>
              <td><table cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td style="padding: 45px; font-family: 'Raleway', sans-serif; font-size: 30px; font-weight: 800; mso-height-rule: exactly; line-height: 28px; color: black; text-align: center"> Welcome To <?= Yii::$app->name; ?>! <br>
                      <br>

						<span style="font-family: 'Raleway', sans-serif; font-size: 16px; font-weight: 400; line-height: 8px;">To log-in to your newly created account you will need this email address and a secure password.</span>
						<br>
                        <span style="font-family: 'Raleway', sans-serif; font-size: 16px; font-weight: 400; line-height: 8px;">Please click on the following button to create your password, once this is done your account will become active.</span><br>
                      ...
                      <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
                        <tr>
                          ...
                          <td style="border-radius: 3px; background: #13bf00; text-align: center; text-decoration: none;" class="button-td">
                            ...
                            <!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->Create Password<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--> 
                            </a></td>
                        </tr>
