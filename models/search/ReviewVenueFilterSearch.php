 ...
 * @copyright 2020
 */
class ReviewVenueFilterSearch extends \app\models\ReviewVenue
{

    /**
     * The rules for the ReviewVenue Search model
     *
     * @return array
     */
    ...
    public function search(array $params = []): ActiveDataProvider
    {
        $query = self::find()
            ->joinWith(['venue'])
            ->where(['{{%review_venue}}.[[venue_id]]' => $params['venue_id']])
            ->andWhere(['{{%venue}}.[[status]]' => self::STATUS_ACTIVE]);
