...
$filteredVenues = ArrayHelper::map($query->andWhere(['!=', 'venue_id', $venueOne->venue_id])->all(), 'venue_id', 'name');
    ...
    <div class="col-sm-6">
        ...
        <?= Html::dropDownList(
            ...
            [
                ...
                'disabled' => true,
                'options' => [
                    $venueOne->venue_id => ['selected' => true]
                ]
            ]
        ); ?>
    </div>
...
<div class="row my-4">
    <div class="col-sm-12">
        <?= Html::a('Compare', ['/compare/venue', 'venue_id_one' => $venueOne->venue_id], ['class' => 'btn btn-primary compare-venue-link']); ?>
    </div>
</div>